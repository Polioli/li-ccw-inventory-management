...
export default {
  ...
  setup() {
    ...
    const getChangeColor = (forecast) => {
      ...
      if (changePercent <= 2) {
        return '#2563eb' // Blue for stable
      }

      if (change > 0) return '#059669' // Green for increasing
      if (change < 0) return '#dc2626' // Red for decreasing
      return '#2563eb' // Blue for no change
    }
